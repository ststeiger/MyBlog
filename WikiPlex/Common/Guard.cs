...
namespace WikiPlex.Common
{
    ...
    public static class Guard
    {
        ...
        /// <exception cref="ArgumentNullException">Thrown if the object is null.</exception>
        /// <exception cref="ArgumentException">Thrown if the object is empty.</exception>
        public static void NotNullOrEmpty<T>(System.Collections.Generic.IList<T> @object, string paramName, string message)
        {
            NotNull(@object, paramName, message);
            ...
            where T : System.IComparable
        {
            if (@object.CompareTo(compareTo) == 0)
                throw new System.ArgumentException("Parameter cannot equal '" + compareTo + "'.", paramName);
        }
    }
}