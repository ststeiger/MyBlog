    ...
    public static class Utility
    {
            ...
            where T : struct
        {
            ...
            return System.Enum.GetNames(type)
                       .Where(n => string.Compare(input.ToString(), n, System.StringComparison.OrdinalIgnoreCase) == 0)
                       .Count() == 1;
        }
        ...
        public static TextPart ExtractTextParts(string input)
        {
            ...
            if (parts.Length > 2)
                throw new System.ArgumentException("Invalid number of parts.", "input");
        ...
        public static ImagePart ExtractImageParts(string input, ImagePartExtras partExtras, bool parseUrl)
        {
            ...
            string[] parameters = toSplit.Split(new[] {','}, System.StringSplitOptions.RemoveEmptyEntries);
            ...
            if ((partExtras & ImagePartExtras.ContainsData) == ImagePartExtras.ContainsData && parameters.Length < 2)
                throw new System.ArgumentException("Invalid number of parameters, cannot find image data.", "input");
        ...
        public static string ExtractFragment(System.Text.RegularExpressions.Regex regex, string input)
        {
