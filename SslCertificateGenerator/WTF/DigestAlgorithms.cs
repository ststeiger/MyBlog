...
namespace SslCertificateGenerator
{
    ...
    public static class DigestAlgorithms
    {
        ...
        private static readonly System.Collections.Generic.Dictionary<string, string> digestNames = new System.Collections.Generic.Dictionary<string, string>();

        /** Maps the name of a digest algorithm with its ID. */
        private static readonly System.Collections.Generic.Dictionary<string, string> allowedDigests = new System.Collections.Generic.Dictionary<string, string>();
        ...
        public static Org.BouncyCastle.Crypto.IDigest GetMessageDigestFromOid(string digestOid)
        {
            return Org.BouncyCastle.Security.DigestUtilities.GetDigest(digestOid);
        }
         ...
         */
        public static Org.BouncyCastle.Crypto.IDigest GetMessageDigest(string hashAlgorithm)
        {
            return Org.BouncyCastle.Security.DigestUtilities.GetDigest(hashAlgorithm);
        }
        ...
        {
            return Digest(Org.BouncyCastle.Security.DigestUtilities.GetDigest(algo), b, offset, len);
        }

        public static byte[] Digest(string algo, byte[] b)
        {
            return Digest(Org.BouncyCastle.Security.DigestUtilities.GetDigest(algo), b, 0, b.Length);
        }
