...
namespace SslCertificateGenerator
{
    ...
    public class NginxHandler
    {
        ...
        private static class NativeMethods
        {
            ...
            public static void Kill(Signum sig, params System.Diagnostics.Process[] processes)
            {
        ...
        {
            NativeMethods.Kill(Signum.SIGHUP, System.Diagnostics.Process.GetProcessesByName("nginx"));
        }
