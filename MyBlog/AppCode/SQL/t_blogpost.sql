...
(
  ...
  bp_title character varying(200),
  bp_content text,
  bp_creoletext text,
  bp_bbcode text,
  bp_htmlcontent text,
  ...
  autoaudit_createdby character varying(128),
  autoaudit_modifieddate timestamp without time zone,
  autoaudit_modifiedby character varying(128),
...
INSERT INTO t_blogpost (bp_uid, bp_title, bp_content, bp_creoletext, bp_bbcode, bp_htmlcontent, bp_entrydate, autoaudit_createddate, autoaudit_createdby, autoaudit_modifieddate, autoaudit_modifiedby, autoaudit_rowversion) VALUES ('e3cfce85-589b-4327-8665-25db76f4098c', 'A pinvoke library for Windows dlls', 'pinvoke  

Platform Invocation Services, commonly referred to as P/Invoke, is a feature of Common Language Infrastructure implementations, like Microsoft''s Common Language Runtime, that enables managed code to call native code.

www.pinvoke.net', NULL, NULL, 'pinvoke  <br /><br />Platform Invocation Services, commonly referred to as P/Invoke, is a feature of Common Language Infrastructure implementations, like Microsoft''s Common Language Runtime, that enables managed code to call native code.<br /><br /><a target="_blank" href="www.pinvoke.net">www.pinvoke.net</a>', '2013-05-03 11:09:22.993333', NULL, NULL, NULL, NULL, 1);
...
-- Completed on 2015-01-30 09:42:10
