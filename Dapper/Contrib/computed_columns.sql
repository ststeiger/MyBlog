...
-- https://github.com/ststeiger/AnySqlWebAdmin/blob/6c4c463852e817b36f6148de32e8757039263148/AnySqlWebAdmin/SQL/columns/computed_columns_definition.sql
...
AND schem.name = 'dbo' -- TABLE_SCHEMA 
-- AND o.name = 'T_AP_Ref_Kostenstelle' -- TABLE_NAME 
-- AND o.name = 'T_BlogPost' -- TABLE_NAME 
-- AND c.is_computed = 0 -- IS_COMPUTED 
